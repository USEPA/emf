...
-----------------------------------------------------------------------------------------
  ...
  -----------------------------------------------------------------------------------------
        ...
        IF ( tmpInteger > 0 )  THEN
          ...
          RAISE NOTICE '         The following will be set to UNK.' ;
  ...
  -----------------------------------------------------------------------------------------
          ...
          LOOP
             ...
             UPDATE tmp_prfwts 
             SET moles = ( tmp_prfwts.percent / 100.) / tbl_species.volatile_mw
             FROM tbl_species
          ...
          UPDATE tmp_calcs_byspc 
          SET gram_per_mole = tbl_species.volatile_mw * tmp_aqm_carbons.num_carbons 
                              / tmp_species_carbons.num_carbons,
              avg_mw = tbl_species.volatile_mw 
        			* tmp_aqm_carbons.num_carbons / tmp_species_carbons.num_carbons
        			* tmp_calcs_byspc.mole_wtpct
          FROM tbl_species, tmp_species_carbons, tmp_aqm_carbons
          WHERE tmp_calcs_byspc.specie_id = tbl_species.specie_id
...
-------------------------------------------------------------------------------------------
        ...
        IF ( runType = haplist )  THEN
           ...
           SET moles_per_gram = tmp_calcs_haps.moles_per_mole / tbl_species.volatile_mw
           FROM tbl_species
           WHERE tmp_calcs_haps.specie_id = tbl_species.specie_id;
           ...
           LOOP
              UPDATE tmp_calcs_haps
              SET avg_mw = tbl_species.volatile_mw
              FROM tbl_species
              WHERE tmp_calcs_haps.specie_id = tbl_species.specie_id
           ...
           LOOP
               ...
               SET avg_mw = tbl_species.volatile_mw
                            * tmp_aqm_carbons.num_carbons
                            / tmp_species_carbons.num_carbons
               FROM tbl_species, tmp_aqm_carbons, tmp_species_carbons
               WHERE hapRow.mechanism = tmp_calcs_haps.mechanism
                 ...
                 AND hapRow.specie_id = tbl_species.specie_id
