...
#Set these directories if needed
#PGINSTALL=/postgres_directory/
#LD_LIBRARY_PATH=${LD_LIBRARY_PATH}:$PGINSTALL/lib
...
#    PERL_BIN=/perl_directory/bin # override the standard Perl installation if needed
...
#        POSTGRES_BIN=/postgres_directory/bin # override the standard PG installation if needed
