...
public class SQLCompareMultipleDatasetsProgramQueryRunner extends SQLQAProgramRunner {
    ...
    public SQLCompareMultipleDatasetsProgramQueryRunner(DbServer dbServer, HibernateSessionFactory sessionFactory, QAStep qaStep) {
    ...
    protected String query(DbServer dbServer, QAStep qaStep, String tableName) throws EmfException {
        SQLCompareMultipleDatasetsProgramQuery parser = new SQLCompareMultipleDatasetsProgramQuery(sessionFactory, dbServer.getEmissionsDatasource(), emissioDatasourceName, tableName, qaStep);
        String sql = "";
        try {
