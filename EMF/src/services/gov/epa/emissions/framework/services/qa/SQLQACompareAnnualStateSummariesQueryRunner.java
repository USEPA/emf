...
public class SQLQACompareAnnualStateSummariesQueryRunner extends SQLQAProgramRunner {
    
    private String emissioDatasourceName;

    public SQLQACompareAnnualStateSummariesQueryRunner(DbServer dbServer, EntityManagerFactory entityManagerFactory, QAStep qaStep) {
    ...
    protected String query(DbServer dbServer, QAStep qaStep, String tableName) throws EmfException {
        SQLCompareAnnualStateSummariesQuery parser = new SQLCompareAnnualStateSummariesQuery(entityManagerFactory, dbServer, emissioDatasourceName, tableName, qaStep);
