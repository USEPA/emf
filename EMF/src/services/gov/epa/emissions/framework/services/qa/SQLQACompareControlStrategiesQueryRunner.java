...
public class SQLQACompareControlStrategiesQueryRunner extends SQLQAProgramRunner {
    
    private String emissioDatasourceName;

    public SQLQACompareControlStrategiesQueryRunner(DbServer dbServer, EntityManagerFactory entityManagerFactory, QAStep qaStep) {
    ...
    protected String query(DbServer dbServer, QAStep qaStep, String tableName) throws EmfException {
        SQLCompareControlStrategyQuery parser = new SQLCompareControlStrategyQuery(entityManagerFactory, emissioDatasourceName, tableName, qaStep);
