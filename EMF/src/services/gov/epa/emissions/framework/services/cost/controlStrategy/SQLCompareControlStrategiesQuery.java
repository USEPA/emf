...
//Summary Tab Info being flattened out...
        ...
        sql.append(" union all " + buildGetControlStrategyColumnValueSQL(controlStrategyId, "Major Pollutant Must Match Target", "match_major_pollutant"));
...
//Constraints Tab Info being flattened out...
        ...
        sql.append(" union all " + buildGetControlStrategyConstraintColumnValueSQL(controlStrategyId, "Maximum Cost per Ton ($/ton)", "min_cost_per_ton"));
        sql.append(" union all " + buildGetControlStrategyConstraintColumnValueSQL(controlStrategyId, "Maximum Annualized Cost ($/yr)", "min_ann_cost"));
