...
public class SQLQAECControlScenarioQueryRunner extends SQLQAProgramRunner {
    
    private String emissioDatasourceName;

    public SQLQAECControlScenarioQueryRunner(DbServer dbServer, EntityManagerFactory entityManagerFactory, QAStep qaStep) {
    ...
    protected String query(DbServer dbServer, QAStep qaStep, String tableName) throws EmfException {
        SQLECControlScenarioQuery parser = new SQLECControlScenarioQuery(entityManagerFactory, dbServer, emissioDatasourceName, tableName, qaStep);
