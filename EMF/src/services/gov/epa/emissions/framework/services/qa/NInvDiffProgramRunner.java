...
public class NInvDiffProgramRunner extends SQLQAProgramRunner {
    
    private String emissioDatasourceName;

    public NInvDiffProgramRunner(DbServer dbServer, EntityManagerFactory entityManagerFactory, QAStep qaStep) {
    ...
    protected String query(DbServer dbServer, QAStep qaStep, String tableName) throws EmfException {
        SQLNInvDiffProgramQuery parser = new SQLNInvDiffProgramQuery(entityManagerFactory, emissioDatasourceName, tableName, qaStep);
