...
public class FireProgramRunner extends SQLQAProgramRunner {
    
    private String emissioDatasourceName;

    public FireProgramRunner(DbServer dbServer, EntityManagerFactory entityManagerFactory, QAStep qaStep) {
    ...
    protected String query(DbServer dbServer, QAStep qaStep, String tableName) throws EmfException {
        SQLQAFireProgramQuery parser = new SQLQAFireProgramQuery(entityManagerFactory, emissioDatasourceName, tableName, qaStep);
        return parser.createFireProgramQuery();
    }
