...
public class SQLQACreateMoEmisByCtyFromAnnEmisQueryRunner extends SQLQAProgramRunner {
    ...
    public SQLQACreateMoEmisByCtyFromAnnEmisQueryRunner(DbServer dbServer, HibernateSessionFactory sessionFactory, QAStep qaStep) {
    ...
    protected String query(DbServer dbServer, QAStep qaStep, String tableName) throws EmfException {
        SQLCreateMoEmisByCtyFromAnnEmisQuery parser = new SQLCreateMoEmisByCtyFromAnnEmisQuery(sessionFactory, dbServer, emissioDatasourceName, tableName, qaStep);
