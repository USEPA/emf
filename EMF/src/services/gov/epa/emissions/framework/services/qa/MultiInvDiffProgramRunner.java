...
public class MultiInvDiffProgramRunner extends SQLQAProgramRunner {
    ...
    public MultiInvDiffProgramRunner(DbServer dbServer, EntityManagerFactory entityManagerFactory, QAStep qaStep) {
    ...
    protected String query(DbServer dbServer, QAStep qaStep, String tableName) throws EmfException {
        SQLMultiInvDiffProgramQuery parser = new SQLMultiInvDiffProgramQuery(entityManagerFactory, emissioDatasourceName, tableName, qaStep);
