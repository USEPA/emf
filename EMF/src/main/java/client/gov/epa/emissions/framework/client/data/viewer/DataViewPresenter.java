...
//                System.out.println("DataViewPresenter.display.SwingWorker.doInBackground start " + new Date());
//                token = viewService().openSession(token);
//                System.out.println("DataViewPresenter.display.SwingWorker.doInBackground end " + new Date() + " " + (System.currentTimeMillis() - start) / 1000);
//                tableMetadata = viewService().getTableMetadata(table);
//                System.out.println("DataViewPresenter.display.SwingWorker.doInBackground end " + new Date() + " " + (System.currentTimeMillis() - start) / 1000);
//                return null;
//            }
//            
