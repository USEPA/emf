...
public class NInvDiffProgramRunner extends SQLQAProgramRunner {
    ...
    public NInvDiffProgramRunner(DbServer dbServer, HibernateSessionFactory sessionFactory, QAStep qaStep) {
    ...
    protected String query(DbServer dbServer, QAStep qaStep, String tableName) throws EmfException {
        SQLNInvDiffProgramQuery parser = new SQLNInvDiffProgramQuery(sessionFactory, emissioDatasourceName, tableName, qaStep);
