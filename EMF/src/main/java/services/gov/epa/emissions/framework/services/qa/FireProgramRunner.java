...
public class FireProgramRunner extends SQLQAProgramRunner {
    ...
    public FireProgramRunner(DbServer dbServer, HibernateSessionFactory sessionFactory, QAStep qaStep) {
    ...
    protected String query(DbServer dbServer, QAStep qaStep, String tableName) throws EmfException {
        SQLQAFireProgramQuery parser = new SQLQAFireProgramQuery(sessionFactory, emissioDatasourceName, tableName, qaStep);
