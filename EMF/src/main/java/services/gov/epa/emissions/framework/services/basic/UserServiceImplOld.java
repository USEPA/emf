...
//    private static Log LOG = LogFactory.getLog(UserServiceImplOld.class);
//
...
//    }
//
//    public UserServiceImplOld(HibernateSessionFactory sessionFactory) {
//        this.sessionFactory = sessionFactory;
//        this.dao = new UserDAOOld();
//        myTag();
//
//        if (DebugLevels.DEBUG_1())
//            System.out.println(">>>> " + myTag());
...
//        EmfProperty property = this.emfPropertyDao.getProperty("EMF-version");
//        return property == null ? null : property.getValue();
//    }
//
//    public synchronized String getEmfPasswordEffDays() throws EmfException {
//        EmfProperty property = this.emfPropertyDao.getProperty("PASSWORD_EFFECTIVE_DAYS");
//        return property == null ? null : property.getValue();
//    }
//
//    @Override
...
//        EmfProperty property = this.emfPropertyDao.getProperty(name);
