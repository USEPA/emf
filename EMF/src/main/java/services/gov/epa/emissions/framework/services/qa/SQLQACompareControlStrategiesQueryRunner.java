...
public class SQLQACompareControlStrategiesQueryRunner extends SQLQAProgramRunner {
    ...
    public SQLQACompareControlStrategiesQueryRunner(DbServer dbServer, HibernateSessionFactory sessionFactory, QAStep qaStep) {
    ...
    protected String query(DbServer dbServer, QAStep qaStep, String tableName) throws EmfException {
        SQLCompareControlStrategyQuery parser = new SQLCompareControlStrategyQuery(sessionFactory, emissioDatasourceName, tableName, qaStep);
