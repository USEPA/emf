...
public class SQLQACompareAnnualStateSummariesQueryRunner extends SQLQAProgramRunner {
    ...
    public SQLQACompareAnnualStateSummariesQueryRunner(DbServer dbServer, HibernateSessionFactory sessionFactory, QAStep qaStep) {
    ...
    protected String query(DbServer dbServer, QAStep qaStep, String tableName) throws EmfException {
        SQLCompareAnnualStateSummariesQuery parser = new SQLCompareAnnualStateSummariesQuery(sessionFactory, dbServer, emissioDatasourceName, tableName, qaStep);
