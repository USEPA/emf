...
public class SQLQACompareVOCSpeciationWithHAPInventoryQueryRunner extends SQLQAProgramRunner {
    ...
    public SQLQACompareVOCSpeciationWithHAPInventoryQueryRunner(DbServer dbServer, HibernateSessionFactory sessionFactory, QAStep qaStep) {
    ...
    protected String query(DbServer dbServer, QAStep qaStep, String tableName) throws EmfException {
        SQLCompareVOCSpeciationWithHAPInventoryQuery parser = new SQLCompareVOCSpeciationWithHAPInventoryQuery(sessionFactory, dbServer, emissioDatasourceName, tableName, qaStep);
