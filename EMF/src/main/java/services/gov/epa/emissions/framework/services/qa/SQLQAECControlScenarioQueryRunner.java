...
public class SQLQAECControlScenarioQueryRunner extends SQLQAProgramRunner {
    ...
    public SQLQAECControlScenarioQueryRunner(DbServer dbServer, HibernateSessionFactory sessionFactory, QAStep qaStep) {
    ...
    protected String query(DbServer dbServer, QAStep qaStep, String tableName) throws EmfException {
        SQLECControlScenarioQuery parser = new SQLECControlScenarioQuery(sessionFactory, dbServer, emissioDatasourceName, tableName, qaStep);
