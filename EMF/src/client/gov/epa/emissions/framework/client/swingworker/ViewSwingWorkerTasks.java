...
public class ViewSwingWorkerTasks extends SwingWorker<Object[], Void> {
    private Container parentContainer;
    private HeavySwingWorkerPresenter presenter;
    private MessagePanel messagePanel;

    public ViewSwingWorkerTasks(Container parentContainer, MessagePanel messagePanel, HeavySwingWorkerPresenter presenter) {
    ...
    public Object[] doInBackground() throws EmfException  {   
        ...
        return presenter.viewProcessData();
    }
