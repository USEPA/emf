...
public class SSInventoryEditDialog extends JDialog {
    ...
    private EditSectorScenarioInputsTab view;

    public SSInventoryEditDialog(EmfConsole parent, EmfDataset dataset,
            EditSectorScenarioInputsTabPresenter presenter,
            EditSectorScenarioInputsTab view) {
        super(parent);
