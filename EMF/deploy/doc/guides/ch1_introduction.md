# Overview of the EMF # {#sec:overview_chapter}
...
[Control Strategy Tool (CoST)]: https://www.cmascenter.org/cost/documentation/3.1/CoST%20User's%20Guide/ {target="_blank"}
