...
27\. Click the **Add** button to add two more inventories. Select the **ORL Point** inventory type from the pull down at the top and add the ptnonipm\_xportfrac\_cap2017ct and ptnonipm\_xportfrac\_cap2017ct\_nc\_sc\_va datasets. To select multiple inventories, **hold down the control key** while clicking the additional inventories.
