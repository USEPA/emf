...
## Command client to restore any pending jobs in the 
## the CaseTaskManager.  This should be run right after
## tomcat is restarted.
...
## cmd client
$JAVA_EXE -Xmx400M -DEMF_HOME=$EMF_HOME -classpath $CLASSPATH gov.epa.emissions.framework.client.EMFPersistedTasksRestoreClient $TOMCAT_SERVER/emf/services 
