...
select '','public','us_county_shape','the_geom',2,4326,'MULTIPOLYGON'
union all select '','public','us_county_shape_nad83','the_geom',2,4269,'MULTIPOLYGON'
union all select '','public','us_state_shape:','the_geom',2,4269,'MULTIPOLYGON'
union all select '','public','us_state_shape_wgs84','the_geom',2,4326,'MULTIPOLYGON';
