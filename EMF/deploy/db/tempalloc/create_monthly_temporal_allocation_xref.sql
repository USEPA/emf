-- SELECT public.create_monthly_temporal_allocation_xref(3, 11, 0);

CREATE OR REPLACE FUNCTION public.create_monthly_temporal_allocation_xref(
  temporal_allocation_id integer,
  inv_dataset_id integer,
  inv_dataset_version integer
  ) RETURNS void AS $$
DECLARE
  profile_type varchar := 'MONTHLY';
