...
public class SpeciationComboProfileImporter implements Importer {
    ...
    public SpeciationComboProfileImporter(File folder, String[] filenames, Dataset dataset, DbServer dbServer,
            SqlDataTypes sqlDataTypes) throws ImporterException {
        FileFormatWithOptionalCols fileFormat = new SpeciationComboProfileFileFormat(sqlDataTypes);
    ...
    public SpeciationComboProfileImporter(File folder, String[] filenames, Dataset dataset, DbServer dbServer,
        ...
        FileFormatWithOptionalCols fileFormat = new SpeciationComboProfileFileFormat(sqlDataTypes, factory
                .defaultValuesFiller());
    ...
    private void doImport(File file, Dataset dataset, String table, FileFormatWithOptionalCols fileFormat,
        ...
        try {
            ...
            reader = new DelimiterIdentifyingFileReader(file, new String[] {"#"},
