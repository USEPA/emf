...
public class ORLDaySpecFiresImporter implements Importer {
    ...
    public ORLDaySpecFiresImporter(File folder, String[] filenames, Dataset dataset, DbServer dbServer,
    ...
    public ORLDaySpecFiresImporter(File folder, String[] filenames, Dataset dataset, DbServer dbServer,
        ...
        FileFormat fileFormat = new ORLDaySpecFiresFileFormat(sqlDataTypes);
