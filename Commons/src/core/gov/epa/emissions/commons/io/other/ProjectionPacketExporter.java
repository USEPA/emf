...
public class ProjectionPacketExporter extends GenericExporter {
    ...
    public ProjectionPacketExporter(Dataset dataset, String rowFilters, DbServer dbServer,DataFormatFactory factory,
        ...
        super(dataset, rowFilters, dbServer, new ProjectionPacketFileFormat(dbServer.getSqlDataTypes()), factory, optimizedBatchSize, filterDataset, filterDatasetVersion, filterDatasetJoinCondition);
    }
