...
//        new StringReader(
        public static void main(String[] args) {
            try {
                CSVReader reader = new CSVReader(new StringReader("ABCDEFG,test,\"test  \"\" sdf sdf s\"\",  q \n"
                        + "another\n\",kW,varchar(255),test,\"test  \"\" sdf sdf s\"\",  q \n"
                        + "another\n"
                        + "might be c\n"
                        + "oming up\n"
                        + "pretty soon\n"
                        + "\n"
                        + "value\""));
                List<String[]> strs = reader.readAll();
