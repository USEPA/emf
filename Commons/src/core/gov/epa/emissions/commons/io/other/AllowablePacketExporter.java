...
public class AllowablePacketExporter extends GenericExporter {
    ...
    public AllowablePacketExporter(Dataset dataset, String rowFilters, DbServer dbServer, DataFormatFactory factory,
        ...
        super(dataset, rowFilters, dbServer, new AllowablePacketFileFormat(dbServer.getSqlDataTypes()), factory, optimizedBatchSize, filterDataset, filterDatasetVersion, filterDatasetJoinCondition);
    }
