...
public class KMLUtils {
	...
	public static String createLookAt(String lonStr, String latStr, String alt,
		...
		lat = Utils.roundDecimalPaces(lat, 6);
		lon = Utils.roundDecimalPaces(lon, 6);

		StringBuilder sb = new StringBuilder();
		sb.append(KMLUtils.openElement(LOOK_AT_TAG, indent));
		sb.append(KMLUtils.createElement(LONGITUDE_TAG, Double.toString(lon),
				indent));
		sb.append(KMLUtils.createElement(LATITUDE_TAG, Double.toString(lat),
				indent));
	...
	public static String createPoint(String lon, String lat, String alt,
			StringBuilder indent) {
		...
		sb.append(KMLUtils.createElement(COORDINATES_TAG, lon + "," + lat + ","
				+ alt, indent));
