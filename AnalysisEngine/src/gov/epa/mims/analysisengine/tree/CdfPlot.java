 ...
 * @version $Id: CdfPlot.java,v 1.3 2006/10/30 21:43:50 parthee Exp $
 * 
 */
public class CdfPlot extends Plot implements Serializable, Cloneable, AnalysisOptionConstantsIfc {
	/** serial version UID */
	...
	/**
	 * List of all data keys which were set in {@link CdfPlot#setDataSetKeys(Object[])}
	 */
	...
	/*******************************************************************************************************************
	 * retrieve a List of all data keys which were set in {@link CdfPlot#setDataSetKeys(Object[])}
	 * 
	...
	/*******************************************************************************************************************
	 * retrieve the i-th data keys which were set in {@link CdfPlot#setDataSetKeys(Object[])}
	 * 
	 * @param i
	 *            index into the Object[] pasted to {@link CdfPlot#setDataSetKeys(Object[])}
	 * 
	...
	private static void initPlotInfo() {
		...
		dataSetInfos[0] = new DataSetInfo("X data series", DataSetIfc.class, 1, -1);
		//
		// initialize the PlotInfo object
		//
		plotInfo = new PlotInfo(AnalysisEngineConstants.CDF_PLOT, CdfPlot.class, allKeywords, dataSetInfos);
	}// initPlotInfo
